...
# train = TorchDataset.dset_CC(375)
# test = TorchDataset.dset_CC(125)
# train = TorchDataset.dset_SP(375)
# test = TorchDataset.dset_SP(125)
...
train(model, lossfn, optimizer, num_epochs=400)
